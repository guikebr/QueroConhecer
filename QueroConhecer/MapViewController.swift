...
class MapViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        showPlaces()
        resquestUserLocationAuthorization()
    }
    ...
    func resquestUserLocationAuthorization() {
    ...
    func addToMap(_ place: Place){
        let annoitation = PlaceAnnotation(coordinate: place.cordinate, type: .place)
        annoitation.title = place.name
        annoitation.address = place.address
        mapView.addAnnotation(annoitation)
    }
    func showPlaces()  {
    ...
    @IBAction func btShowRoute(_ sender: UIButton) {
    ...
    func showMessage(type: MapMessageType) {
        ...
        let message = type == .authorizationWarning ? "Para usar os recursos de localização do App, você precisa permitir o usa na tela de ajustes" : "Não foi possivel encontrar essa rota."
